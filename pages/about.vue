...
defineOgImageComponent('About', {
  ...
  description: 'Dive into web development with me and learn PHP, Laravel, Js, Vue, Nuxt',
  link: '/mahmoud_adel.jpg',
})
</script>
        ...
        <div class="flex justify-between">
          <div>
            ...
            <div class="my-3 space-x-2 md:space-x-3 pb-10">
              <NuxtLink
                to="https://github.com/laravelspa/"
                target="_blank"
              ...
              <NuxtLink
                to="https://www.linkedin.com/in/devmahmoudadel"
                target="_blank"
                class="px-2 py-1 lg:px-3 lg:py-2 bg-gray-300 text-gray-800 rounded-md dark:bg-slate-700 dark:text-[#F1F2F4]"
                aria-label="LinkedIn"
              >
              ...
              <NuxtLink
                to="https://stackoverflow.com/users/19283295/mahmoud-hussien"
                target="_blank"
                class="px-2 py-1 lg:px-3 lg:py-2 bg-gray-300 text-gray-800 rounded-md dark:bg-slate-700 dark:text-[#F1F2F4]"
